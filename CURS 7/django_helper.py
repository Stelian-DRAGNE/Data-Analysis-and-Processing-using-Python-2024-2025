...
if os.name == "nt":
    # Verificare sistem de operare - Windows
    python_command = "python"
else:
    # Verificare sistem de operare - Mac / Linux
...
if __name__ == "__main__":
    create_project("proiectul_meu", "app_1", "app_2")
    
    create_application("app_3", "proiectul_meu")
